...
Get system time in milliseconds \hypertarget{namespaceSimpleCluster_ae1679d348fc3d1e775bb134d36f1d722}{\index{Simple\-Cluster@{Simple\-Cluster}!greg\-\_\-initialize@{greg\-\_\-initialize}}
...
\item[{bool}]{verbose}
\end{DoxyParamCaption}
)}}\label{namespaceSimpleCluster_ae1679d348fc3d1e775bb134d36f1d722}
...
\hline
{\em sum} & vector sum of all points in each cluster \\
\hline
{\em upper} & upper bound on the distance between point data and its assigned center \\
\hline
{\em lower} & lower bound on the distance between point data and its second closest center \\
\hline
{\em label} & the label of point data that specify its assigned cluster \\
\hline
...
After having a set of centers, we need to assign data into each cluster respectively. This solution uses A\-N\-N kd-\/tree search to assign data. 
\begin{DoxyParams}{Parameters}
{\em d} & the dimensions of the data \\
\hline
{\em N} & the number of the data \\
...
After having a set of centers, we need to assign data into each cluster respectively. This solution uses kd-\/tree search to assign data. 
\begin{DoxyParams}{Parameters}
{\em d} & the dimensions of the data \\
\hline
{\em N} & the number of the data \\
...
After having a set of centers, we need to assign data into each cluster respectively. This solution uses linear search to assign data. 
\begin{DoxyParams}{Parameters}
{\em d} & the dimensions of the data \\
\hline
{\em N} & the number of the data \\
...
\hline
\end{DoxyParams}
\hypertarget{namespaceSimpleCluster_a250fa0fe5d53131d30a98b0c22ce611b}{\index{Simple\-Cluster@{Simple\-Cluster}!update\-\_\-center@{update\-\_\-center}}
...
\item[{size\-\_\-t}]{d}
\end{DoxyParamCaption}
)}}\label{namespaceSimpleCluster_a250fa0fe5d53131d30a98b0c22ce611b}
Update the centers 
\begin{DoxyParams}{Parameters}
